...
height:100%;
	...
	<body>
  <nav class="navbar  navbar-expand-lg justify-content-right navbar-light bg-light">
...
<div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item active">
      <img class="d-block img1 w-100" src="https://static.dezeen.com/uploads/2014/01/Dover-Street-Market-fashion-store-New-York_dezeen_ss_2.jpg"
        alt="First slide">
    ...
    <div class="carousel-item">
      <img class="d-block img1 w-100" src="https://www.fashionbeans.com/wp-content/uploads/2017/03/ukindies3.jpg"
        alt="Second slide">
        <div class="carousel-caption d-none d-md-block">
    <h5>Product Available </h5>
    <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
    ...
    <!--Third slide-->
    <div class="carousel-item">
      <img class="d-block img1 w-100" src="https://www.jovafurniture.com/uploadfile/201911/23/0e739d77e61d254ca38d3710f0093e1b_small.jpg"
        alt="Third slide">
        <div class="carousel-caption d-none d-md-block">
    <h5 class="carouseltext">Product Available </h5>
...
if($result->num_rows >0)
{
 ...
 {?>
  <div class="card col-md-5 col-sm-12 card-cascade card-ecommerce wider shadow mb-5 ">
  ...
  ?>
      ...
      <img data-toggle="modal" data-target="#exampleModal" src="<?php echo $imageURL; ?>" alt="" height="90" width="100" />
  ...
  <div class="card-body card-body-cascade text-center">
      <!--Card Title-->
      <h4 class="card-title"><strong><a href=""><?php echo $row['name'] ?></a></strong></h4> <!-- Card Description-->
      <p class="card-text"><?php echo $row['Details']?></p>
      <p class="price"><?php echo $row['price']?></p> <!-- Card Rating-->
